#!/bin/bash
# Phase 2: GRPO with Difficulty-Aware Routing for ALT on 7B base.
set -euo pipefail
...
OUTPUT_DIR="checkpoints/DSR1-Qwen-7B-ALT-RFT"
RESUME_FROM_CHECKPOINT="checkpoints/DSR1-Qwen-7B-ALT-SFT"
